...
/**
 * Class RepositoryBranchProcessor
 *
 * This class is responsible for processing branches from version control repositories.
...
class RepositoryBranchProcessor
{
    ...
    public function execute(string $repo, string $tag, string $repositoryName, ?string $apiKey = null): bool
    {
        ...
        try {
            ...
            // Process the downloaded content using ParseToHtml
            $parser = new ParseToHtml($tempDir, APP_PATH . 'views/docs');
            $parser->execute($repositoryName);
